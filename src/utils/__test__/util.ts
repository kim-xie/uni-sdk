 ...
 */
export function testContainerAPI(container: Container, callback: (globals: Partial<Globals>) => any) {
...
export function testWebAPI(name: string, callback: (globals: Partial<Globals>) => any) {
  describe(`Test Platform API: ${name}`, () => {
